...
const CohortSignup: React.FC = () => {
  ...
  const handlePaymentClick = () => {
    trackButtonClick('bootcamp_payment', {
      page_location: '/bootcamp',
    });
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12 space-y-4">
            ...
            <p className="text-xl md:text-2xl text-gray-300">
              4-Week Intensive: Build Real AI Apps Together
            </p>
          ...
          <div className="bg-gradient-to-br from-red-700/20 to-transparent border border-red-500/40 rounded-2xl p-8 mb-8">
            ...
            <p className="text-lg text-gray-300 mb-8 text-center">
              Master the 4 fundamental principles of AI app development through hands-on, interactive lessons and live cohort sessions.
            </p>
